function [GN] = get_Z_BenedictWebbRubin(GN, object)
%UNTITLED
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% error('Benedict-Webb-Rubin Equation has not been implementet yet')
...
if ~isfield('AGA8_92DC_tables', GN)
    GN = get_BWR_table(GN);
end
...
if isfield(GN,'gasMixProp') && any(ismember({'gasMixProp','all'},object))
    CONST = getConstants();
    [GN.gasMixProp.Z_n_avg, GN.gasMixProp.V_m_n] = calculate_Z_BenedictWebbRubin(CONST.p_n, CONST.T_n);
    GN.gasMixProp.rho_n_avg     = GN.gasMixProp.M_avg / GN.gasMixProp.V_m_n;
    GN.gasMixProp.PHYMOD        = 'BenedictWebbRubin';
end
...
Z = calculate_Z_BenedictWebbRubin(p, T, a, b);
