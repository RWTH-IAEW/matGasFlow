function [c_V] = calculate_c_V_RedlichKwongSoave(V_m, T, M_avg, gasMixAndCompoProp, PHYMOD)
%CALCULATE_C_V_REDLICHKWONGSOAVE Specific isochoric heat capacity c_V [J/(kg*K)]
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
