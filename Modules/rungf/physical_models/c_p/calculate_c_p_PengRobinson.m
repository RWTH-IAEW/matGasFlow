function [c_p, c_p_0] = calculate_c_p_PengRobinson(V_m, T, M_avg, gasMixAndCompoProp, PHYMOD)
%CALCULATE_C_P_PENGROBINSON
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
int_d2p_dT2 = - d2_a_alpha_dT2 .* 1/sqrt(2)/b .* (coth((b+V_m)/sqrt(2)/b)-1);
