function [c_p, c_p_0, dp_dT, dp_dV_m, int_d2p_dT2] = calculate_c_p_RedlichKwong(V_m, T, M_avg, gasMixAndCompoProp, PHYMOD)
%CALCULATE_C_P_REDLICHKWONG Specific isobaric heat capacity c_p [J/(kg*K)] using
...
d2_a_alpha_dT2  =   sum(x_mol_i * x_mol_i' .* sqrt((a_i * a_i') .* sqrt(T_c_i * T_c_i')),"all") *3/4 * T.^(-2.5);
