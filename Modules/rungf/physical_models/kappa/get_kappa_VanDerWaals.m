function [GN] = get_kappa_VanDerWaals(GN, PHYMOD)
...
% kappa
GN.bus.kappa_i = calculate_kappa_VanDerWaals(p, V_m, T, c_p, c_V, GN.gasMixAndCompoProp);
...
if isfield(GN, 'prs')
    ...
    % kappa
    [GN.prs.kappa_ij_mid,GN.prs.dp_dV_m,GN.prs.V_m,GN.prs.a,GN.prs.b] = calculate_kappa_VanDerWaals(p, V_m, T, c_p, c_V, GN.gasMixAndCompoProp);
end
