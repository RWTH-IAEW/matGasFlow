function [kappa] = calculate_kappa_PengRobinson(p, V_m, T, c_p, c_V, gasMixAndCompoProp)
%CALCULATE_KAPPA_PENGROBINSON
%
%   [kappa] = calculate_kappa_PengRobinson(c_p, c_v, p, T, V_m, a, b)
%   Input quantities:
