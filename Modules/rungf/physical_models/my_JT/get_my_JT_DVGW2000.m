function [GN] = get_my_JT_DVGW2000(GN)
%GET_MY_JT_DVGW2000
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
c_p = GN.bus.c_p_i;
GN.bus.my_JT_i = calculate_my_JT_DVGW2000(V_m, T, Z_n_avg, M_avg, c_p);
...
if isfield(GN, 'pipe') || isfield(GN, 'prs')
    ...
    GN.branch.my_JT_ij_out = calculate_my_JT_DVGW2000(V_m, T, Z_n_avg, M_avg, c_p);
end
...
if isfield(GN, 'prs')
    ...
    GN.prs.my_JT_ij_mid = calculate_my_JT_DVGW2000(V_m, T, Z_n_avg, M_avg, c_p);
end
