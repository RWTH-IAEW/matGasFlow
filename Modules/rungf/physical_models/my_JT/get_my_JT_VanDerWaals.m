function [GN] = get_my_JT_VanDerWaals(GN)
...
c_p = GN.bus.c_p_i;
GN.bus.my_JT_i = calculate_my_JT_VanDerWaals(V_m, T, c_p, M_avg, GN.gasMixAndCompoProp);
...
if isfield(GN, 'pipe') || isfield(GN, 'prs')
    ...
    GN.branch.my_JT_ij_out = calculate_my_JT_VanDerWaals(V_m, T, c_p, M_avg, GN.gasMixAndCompoProp);
end
...
if isfield(GN, 'prs')
    ...
    GN.prs.my_JT_ij_mid = calculate_my_JT_VanDerWaals(V_m, T, c_p, M_avg, GN.gasMixAndCompoProp);
end
