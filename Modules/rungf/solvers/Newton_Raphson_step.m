function [GN, success] = Newton_Raphson_step(GN, NUMPARAM, PHYMOD, iter)
%NEWTON_RAPHSON_STEP
%   df_dp\f = Delta_p -->  p_{k+1} = p_k - Delta_p
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Delta_x                     = -GN.J\GN.bus.f; % Alternative: Delta_x = -(GN.J'*GN.J)\(GN.J'*GN.bus.f);
