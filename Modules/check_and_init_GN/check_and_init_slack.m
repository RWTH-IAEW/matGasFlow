...
%% Initialize slack_branch and slack_bus
...
% end
% GN.branch.slack_branch(~GN.branch.in_service) = false;
...
if n_unkowns > sum(GN.bus.supplied)
    GN.bus.V_bus(~GN.bus.slack_bus) = true;
end

%% to_bus of all slack_branches become slack_bus
% GN.bus.slack_bus(GN.branch.i_to_bus(GN.branch.slack_branch & GN.branch.in_service)) = true; % TODO

%% Reset slack_bus setting in areas with more than one slack_bus
